<?php
	...
	if (count($array_link) >= 4) {
		...
		$page_data['make'] = urldecode($array_link[3]);
		$page_data['model'] = urldecode($array_link[4]);
		$page_data['zip'] = $array_link[5];
	}
...
<html>
	<head>
		...
		ga('create', 'UA-48074771-1', 'illbuy.it');
		ga('require', 'displayfeatures');
		ga('send', 'pageview');
		</script>

		<!-- Facebook Conversion Code for Create a Listing -->
		<script>(function() {
		...
		window._fbq.push(['track', '6017947879884', {'value':'0.00','currency':'USD'}]);
		</script>
		<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?ev=6017947879884&amp;cd[value]=0.00&amp;cd[currency]=USD&amp;noscript=1" /></noscript>
	</head>
	<body>
		...
		<div id="headerContainer" style="border-bottom:2px solid">
			<div id="header">
				<div id="logo">
					<img src="images/logo.jpg" style="width: 98px;" />
				</div>
				<div id="poweredBy">
				...
				<div id="menuItems">
					...
					<div class="menuItem"><a href="https://www.youtube.com/watch?v=pUjDr3ctqlg" target="_blank" style="text-decoration:none">VIDEO</a></div>
		...
		<div id="subHeaderContainer">
			...
			<div id="subHeader">
				...
				OUR BEST FRIEND, <b>EDMUNDS.COM</b> JUST TOLD US YOU
				</br>
				NEEDED SOME HELP FINDING A CAR. THIS IS WHAT WE <span style="color: #61B946;"><i>DO</i></span>.
			</div>
		</div>
		...
		<div id="thirdHeaderContainer">
			<div id="thirdHeader">
				...
				<div id="steps">
					...
					<div id="step2">
						<div id="lblStep2"><span style="color: rgb(255, 255, 255); font-size: 19pt; margin-right: 30px;">Step 2</span> Get An Alert</div>
						<div id="step2Desc">
							<div id="phoneImg">
								<img src="images/phone.png" />
							</div>
							<div id="lblStep2Desc">
							Verified sellers compete for your business by sending you offers for vehicles that meet your criteria.
							</div>
						</div>
					</div>
					<div id="step3">
						<div id="lblStep3"><span style="color: rgb(255, 255, 255); font-size: 19pt; margin-right: 44px;">Step 3</span> Drive Home Happy</div>
						<div id="step3Desc">
							<div id="keyImg">
		...
		<div id="makeContainer">
			<div id="make">
				<div id="lblMake">THE <span style="color: #60BC58;">MAKE</span> OF YOUR PERFECT CAR IS...</div>
		...
		<div id="modelSection" class="questionContainer">
			...
			<div class="btnGoBackContainer">
				<div class="btnGoBack">
					<img src="images/btn_goback.png" width="120px" />
				</div>
			</div>
		</div>
		...
		<div id="yearSection" class="questionContainer">
			...
			<div class="lblQuestionContainer">
				<div class="lblQuestion">
					<span style="font-size: 31pt;">GREAT CHOICE.  WHAT YEAR <span class="makeChoosen">ACURA</span> <span class="modelChoosen">TL</span> DO YOU WANT?</span>
				</div>
			</div>
				...
				<div id="year">
					<div class="yearContainer">
						...
						<div class="yearValueContainer">
							...
							<div class="yearArrow">
								<img src="images/year_arrow.png" width="60%" />
							</div>
		...
		<div id="priceSection" class="questionContainer">
			...
			<div id="edmundPriceContainer">
				<div id="edmundPrice">
					...
					<div id="priceTable">
						<div class="edmundPriceItem edmundPriceItemActive oneLine">YEAR</div>
						<div id="tmvYear1" class="edmundPriceItem edmundPriceItemActive oneLine"></div>
						<div id="tmvYear2" class="edmundPriceItem edmundPriceItemActive oneLine"></div>
						<div id="tmvYear3" class="edmundPriceItem edmundPriceItemActive oneLine"></div>
						<div id="tmvYear4" class="edmundPriceItem edmundPriceItemActive oneLine"></div>
						<div class="edmundPriceItem edmundPriceItemActive oneLine">TRADE IN</div>
						<div id="tmvTradeIn1" class="edmundPriceItem oneLine"></div>
						<div id="tmvTradeIn2" class="edmundPriceItem oneLine"></div>
						<div id="tmvTradeIn3" class="edmundPriceItem oneLine"></div>
						<div id="tmvTradeIn4" class="edmundPriceItem oneLine"></div>
		...
		<div id="anythingElseSection" class="questionContainer">
			...
			<div class="lblQuestionContainer">
				<div class="lblQuestion" style="text-align: left;">
					...
					<span style="color: rgb(96, 188, 88); font-size: 21pt;">(I.E. TRIM, EXTERIOR COLOR, NAVIGATION SYSTEM, ETC.)</span>
				</div>
			...
			<div class="questionBackButtonContainer">
				<div class="btnGoBackContainer anythingElseback">
					<div class="btnGoBack anythingElseBack">
						<img src="images/btn_goback.png" width="120px" />
					</div>
				</div>
			</div>
		...
		<div id="contactSection" class="questionContainer">
				...
				<div id="contactForm">
					<form id="cForm">
						...
						<div class="fieldContainer">
							...
							<div class="fieldInput">
								<input id="txtPhone" type="tel" required />
							</div>
						</div>
						<div class="fieldContainer">
						...
						<div class="fieldContainer">
							<div class="fieldLabel contactMethod">WHAT IS YOUR PREFERRED CONTACT METHOD?</div>
							<input id="txtHidden" type="text" style="display:none" required />
							<div class="fieldInputRadio">
								<input type="radio" class="fieldRadio" name="contactMethod" value="0" required>Phone<br>
								<input type="radio" class="fieldRadio" name="contactMethod" value="1">Email<br>
								<input type="radio" class="fieldRadio" name="contactMethod" value="2">Text Message<br>
							</div>
						</div>

						<div id="doneButtonContainer">
							<div id="doneButton"><span>DONE</span></div>
						</div>
					</form>
				</div>
			</div>
			...
			<div class="btnGoBackContainer">
				<div class="btnGoBack  Year_trade">
					<img src="images/btn_goback.png" width="120px" />
				</div>
			</div>
		</div>
